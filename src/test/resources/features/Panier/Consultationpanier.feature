...
Feature: [U9]Consultation du panier
	...
	#Ce test permet de vérifier si la page panier s’ouvre avec les informations de la commande
  @TEST_POEC4-9 @TESTSET_POEC4-65 @GR4_TNR
  Scenario Outline: [U9]Consultation du panier
